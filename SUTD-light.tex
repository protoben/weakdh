...
%\usepackage{pgf}  
%\logo{\pgfputat{\pgfxy(-1,8.32)}{\pgfbox[center,base]{\includegraphics[height=0.6cm]{fancyLogo}}}}
...
\definecolor{Dgrey}{RGB}{37,37,37}
...
% custom footline, based on http://joerglenhard.wordpress.com/2011/08/04/beamer-customization-ii-footline-with-multiple-lines/
